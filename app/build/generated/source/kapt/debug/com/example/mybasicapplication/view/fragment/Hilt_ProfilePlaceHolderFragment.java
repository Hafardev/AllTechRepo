 ...
 */
public abstract class Hilt_ProfilePlaceHolderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfilePlaceHolderFragment() {
    super();
  }

  Hilt_ProfilePlaceHolderFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfilePlaceHolderFragment_GeneratedInjector) this.generatedComponent()).injectProfilePlaceHolderFragment(UnsafeCasts.<ProfilePlaceHolderFragment>unsafeCast(this));
    }
  }

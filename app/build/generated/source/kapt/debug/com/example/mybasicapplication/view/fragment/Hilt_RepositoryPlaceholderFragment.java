 ...
 */
public abstract class Hilt_RepositoryPlaceholderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RepositoryPlaceholderFragment() {
    super();
  }

  Hilt_RepositoryPlaceholderFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RepositoryPlaceholderFragment_GeneratedInjector) this.generatedComponent()).injectRepositoryPlaceholderFragment(UnsafeCasts.<RepositoryPlaceholderFragment>unsafeCast(this));
    }
  }

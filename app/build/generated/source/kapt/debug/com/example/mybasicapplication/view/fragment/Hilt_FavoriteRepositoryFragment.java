 ...
 */
public abstract class Hilt_FavoriteRepositoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteRepositoryFragment() {
    super();
  }

  Hilt_FavoriteRepositoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteRepositoryFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteRepositoryFragment(UnsafeCasts.<FavoriteRepositoryFragment>unsafeCast(this));
    }
  }
